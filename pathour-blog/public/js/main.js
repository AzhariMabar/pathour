async function loadComponent(id, path) {
  ...
  // Setelah header dimuat, jalankan aktivasi nav
  if (id === "header") {
    activateCurrentNav();
  }
}
		...
		$(window).scroll(function(){
			...
			if (st < 150) {
				if ( navbar.hasClass('scrolled') ) {
					...
					logos.src = "./images/Logos/logo-white.png";
				}
			} 
			if ( st > 350 ) {
				if ( !navbar.hasClass('awake') ) {
					navbar.addClass('awake');	
					logos.src = "./images/Logos/logo-dark.png";
				}
